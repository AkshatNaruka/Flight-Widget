...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 bg-gray-800 text-gray-100", className)}
      classNames={{
        ...
        nav_button: cn(
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 hover:bg-gray-700 rounded-md"
        ),
        ...
        day: cn(
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-gray-700 rounded-md transition-colors"
        ),
